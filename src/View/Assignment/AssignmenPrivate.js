import { Box, Button, Checkbox, Divider, InputAdornment, List, ListItem, ListItemButton, ListItemIcon, MenuItem, Select, TextField, Typography } from '@mui/material'
     ...
     return (
          <Box width={'100%'} padding={3} display={'flex'} justifyContent={'center'} flexDirection={'column'}>
               <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'}>
                    <Box>
                         <Typography fontSize={25} sx={{ fontWeight: 'bold' }}>Hãy chọn nhân viên để phân công nhiệm vụ tương ứng</Typography>
                    </Box>
                    <Box>
               ...
               <Box width={'100%'} display={'flex'} flexDirection={'column'} padding={3} >
                    <Box marginBottom={2} display={'flex'} alignItems={'center'}>
                         <Typography>Chọn phòng ban:</Typography>
                         <Select size={'small'} defaultValue={3} sx={{ marginLeft: 2 }} >
                              <MenuItem value={1}>Ban tổ chức tỉnh ủy</MenuItem>
                              <MenuItem value={2}>Ban Tuyên giáo Tỉnh ủyy</MenuItem>
                              <MenuItem value={3}>Tỉnh đoàn</MenuItem>
                         </Select>
                    </Box>
